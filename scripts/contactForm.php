<form name="contactMessage" id="contactMessage">
  <div class="form-group">
    <label class="col-form-label" for="email">Адрес эл. почты: </label>
    <input type="text" class="form-control" name="email" id="email" placeholder="Введите адрес эл. почты">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="phone" id="phone" placeholder="Введите ваш номер телефона">
    <span  id="phone-error" class="er-span"></span>
  </div>
  <div class="form-group">
    <label class="col-form-label" for="message">Cообщение: </label>
    <textarea class="form-control" name="message" rows="5" id="message" placeholder="Введите ваше сообщение"></textarea>
