	...
	<body>
        ...
        <div class="container" id="mainProd">
        	<div class="row">
	        	...
	        	<h1 style="margin-left: 30px;"><?=$data["name"];?></h1>
        			...
        			<div style="z-index: 3; //margin-bottom: 20px; margin-top: 20px;" class="hidden-lg hidden-md col-sm-12 col-xs-12">
        				<div id="carousel" class="carousel slide">
						    ...
						    <div class="carousel-inner">
						        <div class="item active">
						            ...
						            <?php echo "<img src='images/".$pageID."/".$img."'>"; ?>
						        ...
						        <div class="item">
						        <?php echo "<img src='images/".$pageID."/".$img2."'>"; ?>
						        ...
						        <div class="item">
						        <?php echo "<img src='images/".$pageID."/".$img3."'>"; ?>
        			...
        			<div style="margin-top: 20px;" class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
